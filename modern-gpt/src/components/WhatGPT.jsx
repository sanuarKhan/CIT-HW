  ...
  return (
    ...
    >
      <div className="flex pt-10 mb-10">
        <h2 className="w-1/3 text-white what-gpt">What is GPT-3</h2>
      ...
      <div className="flex justify-between mt-20 mb-20">
        <h2 className="text-2xl w-80 bg-gradient-to-r from-fuchsia-400 via-fuchsia-300 to-yellow-600 bg-clip-text text-transparent">
